 ...
 */
        ...
        ECode.calendar = function(options){
            var def = {
                ...
                selRange:{mindate:2014,maxdate:2030},//下拉可选的日期
                flagWeek:true,//日历是否特殊标识
            ...
            var calendarfn = {
                ...
                drawDate:function(oCal,odate){//绘制日历
                    ...
                    if(def.isSelect){
                        ...
                        for(var i = def.selRange.maxdate;i>def.selRange.mindate;i--)i!=this.year?selectHtmls.push('<option value="'+i+'">'+i+'</option> '):selectHtmls.push('<option value="'+i+'" selected>'+i+'</option> ');
                        selectHtmls.push('</select>');
